...
urlpatterns = [
    ...
    path('api/v1/postManagerContacts/',
         views.post_manager_contacts, name='post_manager_contacts'),
    path('api/v1/getTournamentData/<int:tournament_id>/',
         views.get_tournament_by_id, name='get_tournament_data'),
    path('api/v1/patchManagerContact/',
         views.patch_manager_contact, name='patch_manager_contact'),
    path('api/v1/patchTeamResourceUrl/',
         views.patch_team_resource_url, name="patch_team_resource_url"),
    path('api/v1/patchTeamResourceName/',
         views.patch_team_resource_name, name="patch_team_resource_name"),
    path('api/v1/deleteManagerContact/',
         views.delete_manager_contact, name="delete_manager_contact"),
    path('api/v1/deleteTeamResource/',
         views.delete_team_resource, name="delete_team_resource"),
    path('api/v1/postTeamResource/',
