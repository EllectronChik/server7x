...
router.register(r'groupStages', views.groupStageViewSet, basename='groupStages')
...
urlpatterns = [
    ...
    path('api/v1/getPlayerToCurrentTournament/', views.getPlayerToCurrentTournament, name='getPlayerToCurrentTournament'),
    path('api/v1/registredToCurrentSeasonTeams/', views.registredToCurrentSeasonTeams, name='registredToCurrentSeasonTeams'),
    ...
    path('api/v1/setTimeSuggestion/', views.setTimeSuggestion, name='setTimeSuggestion'),
    path('api/v1/acceptTimeSuggestion/', views.acceptTimeSuggestion, name='acceptTimeSuggestion'),
